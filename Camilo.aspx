<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Camilo.aspx.vb" Inherits="Camilo" %>
						...
						<div class="12u">
							...
							<!-- Header -->
								<section id="header">
									...
									<!-- Logo -->
										<a href="#"><img src="images/logo-help.png" alt="" width="63" height="64" /></a><h1><a href="#">Help Game</a></h1>
									...
									<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><a href="right-sidebar.html">VideoJuegos</a></li>
												<li><a href="left-sidebar.html">Sevicios</a></li>
												<li><a href="no-sidebar.html">Galería</a></li>
										  </ul>
										</nav>
							...
							<!-- Banner -->
								<section id="banner">
									<a href="http://facebook.com/DreametryDoodle">
										...
										<header>
											<h2>!Analice La Reparación</h2>
											<span class="byline">De su Consola en Tiempo Real¡</span>
										</header>
									</a>
								</section>
